...
public struct PassField: Codable {
    ...
    public init(attributedValue: PassValue? = nil, changeMessage: String? = nil, dataDetectorTypes: [PassDataDetectorType]? = nil, key: String, label: String? = nil, textAligment: PassTextAlignment? = nil, value: PassValue? = nil) {
